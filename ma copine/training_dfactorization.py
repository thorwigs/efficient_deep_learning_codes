...
from densenet_dfactorization import *
import test
...
import wandb
wandb.login()
project = "training factorization"
...
with wandb.init(project=project, config=config2) as run:
    path = "/homes/c23bosca/Documents/efficient_deep_learning_codes/stats/DN_scheduler_quantized_only"
